			...
			'fields' => array(
				...
				array(
					...
					'options' => array(
						...
						'svg-allow' => __('SVG & ICO files upload<span>Allowing the upload of SVG files is a potential security risk.<br />This option works with Administrator user role only.</span>', 'mfn-opts'),
